...
import { fetchCommentAction, fetchOfferNearbyAction, fetchRoomAction } from '../../store/api-actions';
import { getLoadedComments, getLoadedOffersNearby, getOffer, getOfferLoaded } from '../../store/offers-data/selectors';
