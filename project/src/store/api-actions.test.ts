...
import { makeFakeNewReview, makeFakeOffer, makeFakeReview, makeNewStatus, makeUser } from '../utils/mocks';
import {loadComments, loadOffer, loadOffers, loadOffersFavorite, loadOffersNearby, updateFavorites} from './offers-data/offers-data';
