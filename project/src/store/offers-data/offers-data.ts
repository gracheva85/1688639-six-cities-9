...
const {loadOffers, loadOffersFavorite, loadOffersNearby, loadComments, resetComments, loadOffer, updateFavorites} = offersData.actions;

export {offersData, loadOffers, loadOffersFavorite, loadOffersNearby, loadComments, resetComments, loadOffer, updateFavorites};
